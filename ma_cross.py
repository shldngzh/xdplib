...
if __name__ == "__main__":
    ...
    # %% obtain data by DataReader
    symbol = 'DEM'
    bars = pd.read_excel('Exchange Rates.xlsx',index_col='Pricedate')
    
    # %% initiate strategy and signals
    # Create a Moving Average Cross Strategy instance with a short moving
    # average window of 100 days and a long window of 400 days
    mac = MovingAverageCrossStrategy(symbol, bars, short_window=10, long_window=20)
